...
```bash
@SabrinaAzlee ➜ /workspaces/OSProject (main) $ pwd
...
```bash
@SabrinaAzlee ➜ /workspaces/OSProject (main) $ cat /etc/passwd
...
```bash
@SabrinaAzlee ➜ /workspaces/OSProject (main) $ df
Filesystem     1K-blocks     Used Available Use% Mounted on
overlay         32847680 10380804  20772776  34% /
tmpfs              65536        0     65536   0% /dev
shm                65536        8     65528   1% /dev/shm
/dev/root       30298176 24471792   5810000  81% /vscode
/dev/sdb1       46127956       96  43752284   1% /tmp
/dev/loop3      32847680 10380804  20772776  34% /workspaces
```

4. Run the command **du** . ***(1 mark)*** 

```bash
@SabrinaAzlee ➜ /workspaces/OSProject (main) $ du
4       ./.git/lfs/tmp
8       ./.git/lfs
8       ./.git/objects/f2
8       ./.git/objects/eb
...
```bash
@SabrinaAzlee ➜ /workspaces/OSProject (main) $ ls
README.md  images
```
...
```bash
@SabrinaAzlee ➜ /workspaces/OSProject (main) $ ls -asl
total 40
 4 drwxrwxrwx+ 4 codespace root  4096 Jun 26 05:22 .
 4 drwxr-xrwx+ 5 codespace root  4096 Jun 26 05:23 ..
 4 drwxrwxrwx+ 9 codespace root  4096 Jun 26 05:23 .git
24 -rw-rw-rw-  1 codespace root 22148 Jun 26 05:29 README.md
 4 drwxrwxrwx+ 2 codespace root  4096 Jun 26 05:22 images
```

7. Run the command **free -h** . ***(1 mark)*** 
```bash
SabrinaAzlee ➜ /workspaces/OSProject (main) $ free -h
              total        used        free      shared  buff/cache   available
Mem:          7.7Gi       1.4Gi       237Mi        66Mi       6.1Gi       6.0Gi
Swap:            0B          0B          0B
```
...
```bash
@SabrinaAzlee ➜ /workspaces/OSProject (main) $ cat /proc/cpuinfo
processor       : 0
...
flags           : fpu vme de pse tsc msr pae mce cx8 apic sep mtrr pge mca cmov pat pse36 clflush mmx fxsr sse sse2 ht syscall nx mmxext fxsr_opt pdpe1gb rdtscp lm constant_tsc rep_good nopl tsc_reliable nonstop_tsc cpuid extd_apicid aperfmperf pni pclmulqdq ssse3 fma cx16 pcid sse4_1 sse4_2 movbe popcnt aes xsave avx f16c rdrand hypervisor lahf_lm cmp_legacy svm cr8_legacy abm sse4a misalignsse 3dnowprefetch osvw topoext invpcid_single vmmcall fsgsbase bmi1 avx2 smep bmi2 erms invpcid rdseed adx smap clflushopt clwb sha_ni xsaveopt xsavec xgetbv1 xsaves clzero xsaveerptr rdpru arat npt nrip_save tsc_scale vmcb_clean flushbyasid decodeassists pausefilter pfthreshold v_vmsave_vmload umip vaes vpclmulqdq rdpid fsrm
bugs            : sysret_ss_attrs null_seg spectre_v1 spectre_v2 spec_store_bypass srso
top - 05:30:53 up 38 min,  0 users,  load average: 0.14, 0.31, 0.26
Tasks:  17 total,   1 running,  16 sleeping,   0 stopped,   0 zombie
%Cpu(s):  3.9 us,  3.4 sy,  0.0 ni, 92.3 id,  0.5 wa,  0.0 hi,  0.0 si,  0.0 st
MiB Mem :   7929.6 total,    250.1 free,   1387.1 used,   6292.4 buff/cache
MiB Swap:      0.0 total,      0.0 free,      0.0 used.   6160.9 avail Mem 

    PID USER      PR  NI    VIRT    RES    SHR S  %CPU  %MEM     TIME+ COMMAND                                           
   2290 codespa+  20   0   21.5g 347068  49920 S   1.0   4.3   0:19.72 node                                              
   2822 codespa+  20   0 1115804  59728  42112 S   1.0   0.7   0:00.85 node   
```

10. Run the command **uname -a**. ***(1 mark)*** 

```bash
@SabrinaAzlee ➜ /workspaces/OSProject (main) $ uname -a
Linux codespaces-8d4057 6.5.0-1021-azure #22~22.04.1-Ubuntu SMP Tue Apr 30 16:08:18 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux
```
